//
// Student Management System created by Vaskar Chakma on 30/03/2022.
//
...
int main()
{
    int ch,id,k,i;
    char c,add,pas[50];
    SetConsoleTitle("Student Management System | Nantong University");
    FILE * fp;
    Student s;
    int option;
    char another;
    ...
    {
        printf("Wrong Password . Get The Hell Out of Here");
        getch();
    }
    return 1;
...
void add(FILE * fp)
{
    ...
    while(another=='y'||another=='Y')
    {
        ...
        printf("\n\n\tEnter Your CGPA of First Semester\n");
...
FILE * del(FILE * fp)
{
    ...
    printf("\n\n\tEnter Student ID of Student to Delete the Record");
    printf("\n\n\t\t\tRoll No. : ");
    scanf("%d",&tempRoll);
...
void modify(FILE * fp)
{
    ...
    printf("\n\n\tEnter Student ID of Student to MODIFY the Record : ");
    scanf("%d",&tempRoll);
